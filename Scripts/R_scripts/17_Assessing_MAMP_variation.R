...
### elf18 variants 
col_fun = colorRamp2(c( 0, 50, 100), c("#67001F", "white", "#053061"))
...
draw(elf18_heatmap, show_heatmap_legend = FALSE, padding = unit(c(5, 5, 5, 5), "mm"))
draw(csp22_heatmap, show_heatmap_legend = FALSE, padding = unit(c(5, 5, 5, 5), "mm"))
...
lgd <- Legend(col_fun = col_fun, title = "%AA Similarity", border = "black", title_position = "lefttop-rot",
              grid_width = unit(0.5, "cm"), legend_height = unit(3.3, "cm"))
draw(lgd)
